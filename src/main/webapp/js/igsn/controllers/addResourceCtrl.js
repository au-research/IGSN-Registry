allControllers.controller('addResourceCtrl', ['$scope','$rootScope','$http','$route','$templateCache','$location','modalService','selectListService','$routeParams','$filter','$sce','currentAuthService','$window',
  ...
  $scope.htmlGrantHelp = $sce.trustAsHtml("The Grant Search widget searches across all grant information contributed to Research Data Australia by Australia’s principal research funders. For more information please visit <a target='_blank' href='https://researchdata.edu.au/grants'>https://researchdata.edu.au/grants</a>.")
