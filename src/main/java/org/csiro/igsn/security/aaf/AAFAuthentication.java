...
public class AAFAuthentication implements Authentication {
    ...
    public AAFAuthentication(UserDetails principal, AAFAttributes attributes, AAFJWT jwt, boolean valid) {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        SimpleGrantedAuthority auth = new SimpleGrantedAuthority("ROLE_REGISTRANT"); // All AAF users are limited to user role.
        auths.add(auth);
        return auths;
    }
